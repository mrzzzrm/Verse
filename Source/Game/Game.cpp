...
public:
    ...
    void onApplicationStartup() override
    {
        ...
        //        auto debugGroundPlaneRenderer =
        //        m_world.systemRef<RenderSystem>().renderManager().addRenderer<DebugGroundPlaneRenderer>();
        ...
        //
        //        auto debugNode =
        //        m_world.system<RenderSystem>()->debugGeometryRenderer()->addNode();
        //        auto & pose = debugNode->addPose(Pose3D::atPosition({0.0f,
        //        0.0f, 0.0f}));
