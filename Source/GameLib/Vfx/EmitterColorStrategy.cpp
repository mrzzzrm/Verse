...
EmitterConstColor::EmitterConstColor(const glm::vec4 & color) : m_color(color)
{
}
...
EmitterColorOverLifetime::EmitterColorOverLifetime(
    const glm::vec4 & birthRGBA, const glm::vec4 & deathRGBA)
    : m_birthRGBA(birthRGBA), m_deathRGBA(deathRGBA)
{
}
