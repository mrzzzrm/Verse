...
public:
    ...
    static constexpr u8   NUMBER_OF_BASE_AND_INVERSE_CONFIGS =
        NUMBER_OF_BASE_CONFIGS * 2;

public:
    static VoxelClusterMarchingCubesConfig
    rotateConfigX(VoxelClusterMarchingCubesConfig config);
    static VoxelClusterMarchingCubesConfig
    rotateConfigY(VoxelClusterMarchingCubesConfig config);
    static VoxelClusterMarchingCubesConfig
              rotateConfigZ(VoxelClusterMarchingCubesConfig config);
